              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6 md:mb-8">
                  <div className="flex items-center gap-2 pb-3 border-b-2 border-green-100 dark:border-green-900/30 mb-4 md:mb-6">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-gray-800 dark:text-gray-200">Company Details</h3>
                  </div>
                ...
                <div className="mb-6 md:mb-8">
                  <div className="flex items-center gap-2 pb-3 border-b-2 border-green-100 dark:border-green-900/30 mb-4 md:mb-6">
                    ...
                    <h3 className="text-base md:text-lg font-bold text-gray-800 dark:text-gray-200">Company Logo</h3>
                  </div>
