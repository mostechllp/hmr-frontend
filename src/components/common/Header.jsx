      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <div className="relative" ref={profileRef}>
            ...
            >
              <img
                src={user?.avatar || "https://violet-leopard-500489.hostingersite.com/hr/public/storage/avatars/jnBiWzD1Lt4YMtHS4hK2CS0Pcbo3vSOZw7Xd6px4.jpg"}
                alt="Profile"
                ...
                <div className="p-4 flex gap-3 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200">
                      {user?.name || user?.username || "HR Admin"}
                    </h4>
